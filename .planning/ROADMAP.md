...
Plans:
- [ ] 01-01-PLAN.md — G1: ghim đủ cấu hình git trong lớp sinh tiến trình (PLAT-02), test đọc ngược từ tiến trình con
- [ ] 01-02-PLAN.md — G4: dựng hạ tầng vitest và test hai ràng buộc kiến trúc PLAT-04, PLAT-05
...
|-------|----------------|--------|-----------|
| 1. Nền tảng và lớp bọc git | 0/4 | Planned | - |
