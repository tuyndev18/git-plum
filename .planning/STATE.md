...
| fast | Đồ thị kiểu GitKraken: đường nối nhãn → nút, vạch màu lane mép cột thông điệp, tag ám màu lane + icon, ngày `MM/DD/YYYY @ h:mm` | 2026-09-23 | 577ef0a | — |
| fast | Đồ thị: --date-order + thuật toán straight branches (pvigier) thay lane chờ — hết bậc thang merge; list không còn cắt cụt ở ranh giới trang | 2026-09-23 | f7a3a25, 130fee5 | — |
| fast | Commit nhiều ref kiểu GitKraken: một nhãn chính (HEAD ✓ trước) + `+N`, hover mở popover đủ ref, gộp local+remote cùng tên (icon máy/đám mây) | 2026-09-23 | 9bfaf58 | — |
